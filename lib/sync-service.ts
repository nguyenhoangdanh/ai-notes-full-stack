...
export class SyncService {
  ...
  constructor() {
    ...
    const syncEnabled = process.env.NEXT_PUBLIC_ENABLE_SYNC !== 'false'
    if (syncEnabled) {
  ...
  private getApiBase(): string {
    return process.env.NEXT_PUBLIC_API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:3001'
  }
